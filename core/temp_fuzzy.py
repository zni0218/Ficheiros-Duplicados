"""
build_index_temp_fuzzy.py

Teste simples de indexação para fuzzy_chunks.
...
from indexing.fuzzy_chunks import compute_index_fuzzy_chunks
...
def build_fuzzy_index(base: Path, out: Path, debug=False):
    ...
    csv_path = out / "fuzzy_chunks_test_index.csv"
    ...
    # ========================================================
    # ✅ INDEXAÇÃO (FALTAVA ISTO)
    # ========================================================

    raw_index = compute_index_fuzzy_chunks(files, debug=debug)
    ...
    for r in raw_index:
        ...
        try:
            ...
            rows.append({
                ...
                "fingerprint": r["fingerprint"],  # ✅ string já
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Teste fuzzy_chunks index"
    )
